package com.vein.vlibs.view.pickerview.lib;
...
import com.vein.vlibs.utils.JResourceUtils;
import com.vein.vlibs.view.pickerview.adapter.WheelAdapter;
import com.vein.vlibs.view.pickerview.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    private static final boolean PICKERVIEW_CUSTOMTEXTSIZE = false;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        JResourceUtils resource = JResourceUtils.getInstance(context);
//        textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        textColorOut = resource.getColor("mc_forum_text4_desc_normal_color");
//        textColorCenter = getResources().getColor(R.color.pickerview_wheelview_textcolor_center);
        textColorCenter = resource.getColor("mc_forum_text4_normal_color");
//        dividerColor = getResources().getColor(R.color.pickerview_wheelview_textcolor_divider);
        dividerColor = resource.getColor("mc_forum_text4_flat_other_normal_color");
        //配合customTextSize使用，customTextSize为true才会发挥效果
        int textSizeDimenId = resource.getDimenId("pickerview_textsize");
        textSize = getResources().getDimensionPixelSize(textSizeDimenId);
//        customTextSize = getResources().getBoolean(R.bool.pickerview_customTextSize);
        customTextSize = PICKERVIEW_CUSTOMTEXTSIZE;
        if(attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs,resource.getStyleableArray("wheelview"),0,0);
            mGravity = a.getInt(resource.getStyleable("wheelview_gravity"), Gravity.CENTER);
            textColorOut = a.getColor(resource.getStyleable("wheelview_textColorOut"), textColorOut);
            textColorCenter = a.getColor(resource.getStyleable("wheelview_textColorCenter"),textColorCenter);
            dividerColor = a.getColor(resource.getStyleable("wheelview_dividerColor"),dividerColor);
            textSize = a.getDimensionPixelOffset(resource.getStyleable("wheelview_textSize"),textSize);
        }
